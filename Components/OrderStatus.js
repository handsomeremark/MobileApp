...
const styles = StyleSheet.create({
    ...
    mapContainer: { height: 350, backgroundColor: '#e0e0e0', borderRadius: 10, marginBottom: 20, justifyContent: 'center', alignItems: 'center' },
    mapPlaceholder: { fontSize: 18, color: '#888' },
    orderStatus: { marginTop: 10 },
    orderDetails: { backgroundColor: '#336841', padding: 20, borderRadius: 10, marginBottom: 15 },
    orderMessage: { fontSize: 18, fontWeight: 'bold', color: '#fff', marginBottom: 10, textAlign: 'center' },
    orderNumber: { fontSize: 16, color: '#fff', textAlign: 'center' },
    courierInfo: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 10, backgroundColor: '#f2f2f2', borderRadius: 10, marginBottom: 10, height: 120 },
    courierDetails: { flexDirection: 'row', alignItems: 'center', flex: 1 },
    courierIcon: { width: 50, height: 50, borderRadius: 30, backgroundColor: '#ccc', marginRight: 10 },
    courierText: { flex: 1 },
    courierTitle: { fontSize: 16, fontWeight: 'bold', marginBottom: 5 },
    courierName: { fontSize: 14 },
    courierPhone: { fontSize: 14, color: '#777' },
    chatButton: { backgroundColor: '#336841', padding: 10, borderRadius: 50, justifyContent: 'center', alignItems: 'center' },
});
