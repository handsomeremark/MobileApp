...
const styles = StyleSheet.create({
    ...
    paragraph: { marginBottom: 20, fontSize: 12, marginTop: 10, color: '#575450' },
    input: { height: 50, borderWidth: 1, borderColor: '#ccc', borderRadius: 5, paddingHorizontal: 20, marginBottom: 20 },
    passwordInputContainer: { position: 'relative', width: '100%' },
    eyeIconContainer: { position: 'absolute', top: 15, right: 15 },
    verifyButton: { backgroundColor: '#336841', width: '100%', borderRadius: 5, paddingVertical: 15, alignItems: 'center', marginTop: 20 },
