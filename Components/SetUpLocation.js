...
<<<<<<< HEAD
    ...
    searchInput: { flex: 1, height: 40, backgroundColor: '#D9D9D9', borderRadius: 5, paddingHorizontal: 10 },
    map: { width: '95%', height: 660, alignSelf: 'center', top: 60 },
    buttonContainer: { backgroundColor: '#336841', width: '90%', borderRadius: 5, paddingVertical: 15, alignItems: 'center', alignSelf: 'center', position: 'absolute', bottom: 20 },
