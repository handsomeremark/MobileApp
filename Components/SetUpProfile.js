...
const styles = StyleSheet.create({
    container: { flex: 1, justifyContent: 'center', alignItems: 'center', paddingHorizontal: 20, backgroundColor: "white" },
    label: { fontSize: 14, marginBottom: 5, alignSelf: 'flex-start' },
    input: { height: 50, borderWidth: 1, borderColor: '#ccc', borderRadius: 5, paddingHorizontal: 15, marginBottom: 20, width: '100%' },
    button: { backgroundColor: '#336841', borderRadius: 5, paddingVertical: 10, paddingHorizontal: 20, alignSelf: 'flex-end' },
    profileImage: { width: 150, height: 150, borderRadius: 75, marginBottom: 20 },
    profileImagePlaceholder: { width: 150, height: 150, borderRadius: 75, marginBottom: 20, backgroundColor: '#ccc', justifyContent: 'center', alignItems: 'center' },
    buttonSkip: { paddingVertical: 8.5, paddingHorizontal: 50, position: 'relative', bottom: 46, right: 90, borderWidth: 1, borderColor: '#336841', borderRadius: 5 },
    skipTextButton: { color: '#000000', fontSize: 18 },
