...
const styles = StyleSheet.create({
    ...
    tabsContainer: { flexDirection: 'row', justifyContent: 'space-around', padding: 1 },
    tab: { width: '40%', borderRadius: 5, paddingVertical: 10, alignItems: 'center', marginBottom: 10, borderWidth: 1, borderColor: '#ccc' },
    activeTab: { backgroundColor: '#336841', borderColor: '#00b050' },
    ...
    sectionNewsHeader: { fontSize: 18, fontWeight: 'bold', marginBottom: 5 },
    notification: { flexDirection: 'row', alignItems: 'center', padding: 16, marginBottom: 10, backgroundColor: '#f5f5f5', borderRadius: 10 },
    circle: { width: 40, height: 40, borderRadius: 20, backgroundColor: '#ccc', marginRight: 16 },
    info: { flex: 1 },
    title: { fontSize: 16, fontWeight: 'bold' },
    titleUpdate: { fontSize: 16, fontWeight: 'bold', color: 'red' },
    date: { fontSize: 14, color: '#336841', marginBottom: 4 },
    Newsdate: { fontSize: 14, color: '#666', alignSelf: 'flex-end', bottom: 22 },
