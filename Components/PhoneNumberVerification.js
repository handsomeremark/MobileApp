...
const styles = StyleSheet.create({
    ...
    paragraph: { fontSize: 14, marginBottom: 30, top: 15 },
    inputContainer: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 20 },
    input: { height: 50, width: '15%', borderWidth: 1, borderColor: '#ccc', borderRadius: 5, paddingHorizontal: 15, textAlign: 'center' },
    verifyButton: { backgroundColor: '#336841', width: '100%', borderRadius: 5, paddingVertical: 15, alignItems: 'center', bottom: 20 },
    resendButton: { marginTop: 10, alignItems: 'center' },
    resendText: { alignSelf: 'center', top: 90, right: 35 },
    resendTextButton: { alignSelf: 'center', color: '#3D50FC', top: 69, left: 72 },
